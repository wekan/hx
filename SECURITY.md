...
You can [Install Wekan.hx](https://github.com/wekan/hx/releases) to your own computer
and scan it's vulnerabilities there.

## About Wekan.hx versions

There is only one prototype of Wekan.hx, that does not even work yet.

## What Wekan.hx bugs are eligible?
...
## What Wekan.hx bugs are NOT eligible?
